...
// SigmaStar DMA samples per frame (1024 samples)
#define DEFAULT_AO_PT_NUM_PER_FRM 1024

// SigmaStar DMA chunk size in bytes: 1024 samples * 2 bytes (16-bit depth) = 2048 bytes
